...
raytracer.envMap = pg.image.load("fondo.png")
...
raytracer.scene.append(AABB(position=(0,-1,-10), size=(8,0.8,8), material=tablero))
...
#Agua - 1 plano
raytracer.scene.append(Plane(position=(0,-1,0), normal=(0,1,0), material=glass))
...
raytracer.lights.append(DirectionalLight(direction=(0,0,-1), intensity=1))
raytracer.lights.append(DirectionalLight(direction=(0,0,1), intensity=0.5))
raytracer.lights.append(DirectionalLight(direction=(-1,0,-1), intensity=1))
raytracer.lights.append(DirectionalLight(direction=(0,-1,-1), intensity=1))
...
raytracer.lights.append(PointLight(point=(-5,10,-10), intensity=1, color=(1,1,0)))
raytracer.lights.append(PointLight(point=(-3,5,-10), intensity=1, color=(1,1,0)))
